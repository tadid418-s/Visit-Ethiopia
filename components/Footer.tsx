      ...
      <div className="padding-container max-container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          <Link href="/" className="mb-10">
            <img src="/hilink-logo.svg" alt="Visit Ethiopia logo" width={74} height={29} style={{ width: 'auto', height: 'auto' }} />
          </Link>
        ...
        <p className="regular-14 w-full text-center text-gray-30">2025 Visit Ethiopia | All rights reserved</p>
      </div>
    </footer>
  )
}
